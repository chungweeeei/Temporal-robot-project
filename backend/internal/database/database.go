...
func ensureDatabaseExists() {
	...
	dsn := "host=postgresql.temporal-robot-project.orb.local user=admin password=admin dbname=postgres port=5432 sslmode=disable TimeZone=Asia/Taipei"
...
func connectToDB() *gorm.DB {
	...
	dsn := "host=postgresql.temporal-robot-project.orb.local user=admin password=admin dbname=robot_workflow port=5432 sslmode=disable TimeZone=Asia/Taipei"
